...
public class WeatherService {
	...
	public Flux<WeatherEvent> streamWeather() {
		...
		Flux<WeatherEvent> events = Flux
				.fromStream(Stream.generate(() -> new WeatherEvent(new Weather(getTemperature(), getHumidity(), getWindSpeed()), LocalDateTime.now())));
	...
	private String getTemperature() {
		String[] temperatures = "19C,19.5C,20C,20.5C,21C,21.5 C,22C,22.5C,23C,23.5C,24C" .split(",");
